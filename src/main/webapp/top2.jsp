...
<script type="text/javascript">
	function checkSearch() {
		...
		if(null!=content&&""!=content){
			location.href="${pageContext.request.contextPath }/searchTopic.do";
		}else{
			alert("请输入搜索内容!");
		}
	}
...
<div class="search" align="right" style="padding-top: 10px;padding-right: 10px">
	<form action="${pageContext.request.contextPath }/searchTopic.do" method="post">
