...
var TableInit = function () {
    ...
    oTableInit.Init = function () {
        $('#tradeList').bootstrapTable({
            url: '${pageContext.request.contextPath }/showTopics.do',         //请求后台的URL（*）
            method: 'get',                      //请求方式（*）
...
function delTopic(tid) {
	$.post("${pageContext.request.contextPath }/delTopic.do",
		{tid:tid},
...
function topicDetail(tid) {
  ...
  <div class="panel-heading" align="center">帖子列表</div> 
